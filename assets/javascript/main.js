...
var questions = [{
    ...
    answerList: ["Thomas Edison", "Albert Einstein", "Alexander Bell", "Nikola Tesla"],
    answer: 2
},{
    question: "What agreement with Mexico gave territory to include what is now Tucson to the United States?",
    answerList: ["Guadalupe-Hidalgo Treaty", "Gadsen Purchase", "Treaty of Versaille", "Marshall Plan"],
    answer: 1
},{
    question: "Where was Lope de Vega born?",
    answerList: ["London", "Tucson", "Guadalajara", "Madrid"],
    answer: 3
},{
    question: "Who did Lady Diana Spencer marry?",
    answerList: ["Prince Royce", "John D. Rockefeller", "Don King", "Prince Charles"],
    answer: 3
},{
    question: "How many U.S. States and territories are there?",
    answerList: ["50", "56", "48", "60"],
    answer: 1
},{
    question: "What did Joseph Priesley discover in 1774?",
    answerList: ["Elvis", "The Moon", "Oxygen", "Algebra"],
    answer: 2
},{
    question: "Who lived at 221B, Baker Street, London?",
    answerList: ["Sir Winston Chuchill", "The Spice Girls", "Queen Elizabeth II", "Sherlock Holmes"],
    answer: 3
}];
